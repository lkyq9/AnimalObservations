...
struct animalsEvent{
    ...
    let classification: Animals
    let title: String
    let description: String
    let date: Date
    
    init(classification: Animals, title: String, description: String, date:Date)
    {
    ...
    init?(classificationName: String, title: String,description: String, date: Date){
        ...
        if let classification = Animals(rawValue: classificationName){
